# -*- coding: utf-8 -*-
from src.Common import get_pickle, __sort_dict_keys__
...
class DatasetClass:
    ...
    def __init__(self, config):
        self.CONFIG = __sort_dict_keys__(config)  # Ordenar para evitar cambios en MD5
        
        if "save_path" in self.CONFIG.keys(): # Hay conjuntos que no hace falta almacenar en disco
